...
MANUAL_MAP = {
    ...
    "libratbag":                  "MISSING: not yet added",
    "wireguard-tools":            "MISSING: not yet added",
    "ex-vi-compat":               "SKIP: vim covers this",
    "cpupower":                   "MISSING: not yet added",
    "drm-info":                   "MISSING: not yet added",
    "libva-utils":                "MISSING: not yet added",
    "lshw":                       "MISSING: not yet added",
    "man-db":                     "MISSING: not yet added",
    "man-pages":                  "MISSING: not yet added",
    "plocate":                    "MISSING: not yet added",
    "turbostat":                  "SKIP: x86-specific, part of linux-tools",
    "udftools":                   "MISSING: not yet added",
    "yubikey-manager":            "MISSING: needs python/libfido2 deps",
    "android-tools":              "MISSING: not yet added (adb/fastboot)",
    "alsa-utils":                 "MISSING: not yet added",
    "cdemu-client":               "SKIP: virtual disc mounting → Flatpak",
    "espeak-ng":                  "MISSING: not yet added",
    "fastfetch":                  "MISSING: not yet added",
    "bluez-utils":                "MISSING: not yet added (bluez in FDO but not CLI tools)",
